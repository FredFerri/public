           ...
           if(is_front_page())
            {?>
                ...
                <section style="background: linear-gradient(0deg, rgba(235,31,124,1) 0%, rgba(235,31,124,1) 25%, rgba(113,6,55,1) 100%);margin-top: 26px;display: inline-block;width: 70%;padding: 10px;background-color: #EB1F7C;color: #FFFFFF;padding-left: 15%;padding-right: 15%;">
		            ...
		            if(isset($_GET['diffusion']) && $_GET['diffusion'] != ''){
						...
						$cache_key = 'footer_last_emissions_' . md5(json_encode($argsNews));
                ...
                <section style="background: linear-gradient(0deg, rgb(255,91,168) 0%, rgb(255,91,168) 25%, rgba(235,31,124,1) 100%);display: inline-block;width: 70%;padding: 10px;color: #FFFFFF;padding-left: 15%;padding-right: 15%;">
		            ...
		            if(isset($_GET['diffusion']) && $_GET['diffusion'] != ''){
						...
						$cache_key = 'footer_last_podcasts_' . md5(json_encode($argsTest));
						$cached_results = get_transient($cache_key);
           ...
           <footer class="footerHighlight" >
            <div class="inside">
              <div class="footerHighlight__widgets">
              ...
              <ul class="social social--bottom">
                ...
                <li class="social__icon social__icon--rss"><a href="../../feed" target="_blank" title="Le flux RSS du site bx1.be">RSS</a></li>
              </ul>
            </div>
           </footer>
  ...
  <?php if(is_page('alertez-nous') || is_page('votrebxl')): ?>
