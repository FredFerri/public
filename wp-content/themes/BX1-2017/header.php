            ...
            ?>
                ...
                if ($count <= 4) { ?>
                  <li class="meteo__block">
                    ...
                    <span class="meteo__block__icon meteo__block__icon--<?php $icon = $CAS[$donnee["weather"][0]["id"]];
                                                                        echo $icon; ?>" title="<?php echo $donnee["weather"][0]["description"]; ?>"><?php echo $donnee["weather"][0]["description"]; ?></span>
                    <span class="meteo__block__temp"><?php echo round($donnee["temp"]["max"], 0); ?>&nbsp;<span>°C</span></span>
                  </li>
            <?php }
              }
