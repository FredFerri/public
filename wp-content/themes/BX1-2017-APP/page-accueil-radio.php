...
<style>
  ...
  .sideFil .mireRadio span,
  .listeEmissions span,
  .listeChroniques span {
    display: block;
  }

  .sideFil .mireRadio span.mireradiotitre,
  .listeEmissions span.titreEmission,
  .listeChroniques span.titreChronique {
    font-weight: bold;
    padding-left: 12px;
  }

  .sideFil .mireRadio span.mireradiosstitre,
  .listeEmissions span.dateEmission,
  .listeChroniques span.dateChronique {
    padding-left: 20px;
    font-size: 0.8em;
    font-style: italic;
  }
...
<div style="margin-bottom: 10px;">
  ...
  <span style="background-color: #e2237a;
    ...
    display:block;
    font-family: sys-tt;">
    <a href="https://bx1.be/grille-radio/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>" style="display: block; text-align: center; font-size: 1.3em; color: #ffffff; font-weight: bolder">📻 Découvrez la grille des programmes de notre radio 📻</a>
  </span>
...
<section class="sideFil " style="padding-bottom:50px;">
  <span class="titremireRadio">Le programme du jour</span>
  ...
  wp_reset_postdata();
    ...
    while ($loop->have_posts()) : ?>
      <div class="mireRadio">
        ...
        <span class="mireradiotitre" style="padding-top: 10px;">09h00 | <a href="https://bx1.be/radio-type_emissions/le-brunch/">Le Brunch</a></span><span class="mireradiosstitre">
          <?php
          $loop->the_post();
          $do_not_duplicate[] = $post->ID;
          echo types_render_field('nom-animation'); ?>
    ...
    <?php
    $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'crossover'));
    while ($loop->have_posts()) : ?>
      <div class="mireRadio">
        <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>

        <span class="mireradiotitre">11h30 | Crossover</span><span class="mireradiosstitre spacer">
          <?php
          $loop->the_post();
          $do_not_duplicate[] = $post->ID;
          echo types_render_field('nom-animation'); ?>
    ...
    wp_reset_postdata();
      ...
      wp_reset_postdata();
        ...
        <?php
        $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'stoemelings'));
        while ($loop->have_posts()) : ?>
          <div class="mireRadio">
            <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
            <span class="mireradiotitre">13h25 | <a href="https://bx1.be/radio-type_emissions/en-stoemelings/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">En Stoemelings</a></span><span class="mireradiosstitre">
              <?php
              $loop->the_post();
              $do_not_duplicate[] = $post->ID;
              echo types_render_field('nom-animation'); ?>
        ...
        wp_reset_postdata();
          ...
          while ($loop->have_posts()) : ?>
            <div class="mireRadio">
              <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
              <span class="mireradiotitre">14h30 | <a href="https://bx1.be/radio-type_emissions/bruxelles-vit/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">Bruxelles vit !</a></span><span class="mireradiosstitre">
                <?php
                $loop->the_post();
                $do_not_duplicate[] = $post->ID;
                echo types_render_field('nom-animation'); ?>
          ...
          wp_reset_postdata();
            ...
            while ($loop->have_posts()) : ?>
              <div class="mireRadio">
                <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                <span class="mireradiotitre">16h30 | <a href="https://bx1.be/radio-type_emissions/plus-de-podcast/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">Podcast +</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
            ...
            wp_reset_postdata();
              ...
              <?php
              $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'rapolog'));
              while ($loop->have_posts()) : ?>
                <div class="mireRadio">
                  <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                  <span class="mireradiotitre">20h00 | <a href="https://bx1.be/radio-type_emissions/rapolog/">Rapol'OG</a></span><span class="mireradiosstitre">
                    <?php
                    $loop->the_post();
                    $do_not_duplicate[] = $post->ID;
                    echo types_render_field('nom-animation'); ?>
              ...
              wp_reset_postdata();
                ...
                <?php
                $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'octave'));
                while ($loop->have_posts()) : ?>
                  <div class="mireRadio">
                    <h2 style="padding-top: 5px; color: #b5115d; text-align:center; margin-top: 25px; margin-bottom: 15px; border-top-style: solid; border-top-width: 3px;">SAMEDI</h2>
                    <span class="mireradiotitre">18h15 | <a href="https://bx1.be/radio-type_emissions/octave-plus/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">Octave</a></span><span class="mireradiosstitre">
                      <?php
                      $loop->the_post();
                      $do_not_duplicate[] = $post->ID;
                      echo types_render_field('nom-animation'); ?>
                ...
                <?php
                $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'le-grand-journal-du-rien'));
                while ($loop->have_posts()) : ?>
                  <div class="mireRadio">
                    <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                    <span class="mireradiotitre">19h00 | <a href="https://bx1.be/radio-type_emissions/le-grand-journal-du-rien/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">Le Grand Journal du Rien</a></span><span class="mireradiosstitre">
                      <?php
                      $loop->the_post();
                      $do_not_duplicate[] = $post->ID;
                      echo types_render_field('nom-animation'); ?>
                ...
                <?php
                $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'ta-bruxelles'));
                while ($loop->have_posts()) : ?>
                  <div class="mireRadio">
                    <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                    <span class="mireradiotitre">20h00 | <a href="https://bx1.be/radio-type_emissions/t-a-bruxelles/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">T A Bruxelles ?</a></span><span class="mireradiosstitre">
                      <?php
                      $loop->the_post();
                      $do_not_duplicate[] = $post->ID;
                      echo types_render_field('nom-animation'); ?>
                ...
                wp_reset_postdata();
                  ...
                  while ($loop->have_posts()) : ?>
                    <div class="mireRadio">
                      <h2 style="padding-top: 5px; color: #b5115d; text-align:center; margin-top: 25px; margin-bottom: 15px; border-top-style: solid; border-top-width: 3px;">DIMANCHE</h2>
                      <span class="mireradiotitre">13h00 | <a href="https://bx1.be/radio-type_emissions/club-du-dimanche/">Le Club du Dimanche</a></span><span class="mireradiosstitre">
                        <?php
                        $loop->the_post();
                        $do_not_duplicate[] = $post->ID;
                        echo types_render_field('nom-animation'); ?>
                  ...
                  <?php
                  $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => 'troisieme-mt'));
                  while ($loop->have_posts()) : ?>
                    <div class="mireRadio">
                      <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                      <span class="mireradiotitre">18h15 | <a href="https://bx1.be/radio-type_emissions/la-3e-mi-temps/">La 3e mi-temps</a></span><span class="mireradiosstitre">
                        <?php
                        $loop->the_post();
                        $do_not_duplicate[] = $post->ID;
                        echo types_render_field('nom-animation'); ?>
                  ...
                  wp_reset_postdata();
                    ...
                    <?php
                    $loop = new WP_Query(array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique', 'meta_value' => '100-rock'));
                    while ($loop->have_posts()) : ?>
                      <div class="mireRadio">
                        <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                        <span class="mireradiotitre">20h00 | <a href="https://bx1.be/radio-type_emissions/100-rock/">100% Rock</a></span><span class="mireradiosstitre">
                          <?php
                          $loop->the_post();
                          $do_not_duplicate[] = $post->ID;
                          echo types_render_field('nom-animation'); ?>
