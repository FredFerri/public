...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:spotify="http://www.spotify.com/ns/music/1" version="2.0">
    <channel>
        ...
        <description>
            <![CDATA[Du lundi au vendredi à 17h00, Fabrice Grosfilley reçoit un.e invité.e dans + d’Actu pour évoquer l’actualité du jour.]]>
        </description>
        <itunes:summary>
            Du lundi au vendredi à 17h00, Fabrice Grosfilley reçoit un.e invité.e dans + d’Actu pour évoquer l’actualité du jour.
        </itunes:summary>
        <copyright>
        ...
        $loop = new WP_Query(array('post_type' => 'radio-chronique', 'meta_key' => '_yoast_wpseo_primary_radio-type_emissions', 'meta_value' => '13258', 'posts_per_page' => -1));
