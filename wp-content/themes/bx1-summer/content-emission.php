            ...
            jwplayer("video").setup({
                playlist: [{
                    ...
                    sources: [{
                        ...
                        file: "http://149.202.81.107:1935/vod/mp4:" + "<?php echo types_render_field('nom-du-fichier-video'); ?>" + ".mp4" + "/playlist.m3u8",type: "mp4"},{
                        file: "rtsp://149.202.81.107:1935/vod/" + "<?php echo types_render_field('nom-du-fichier-video'); ?>" + ".mp4"
                    }]
                }],
                primary: "html5",
                width: "100%",
