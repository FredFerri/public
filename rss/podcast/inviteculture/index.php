...
echo '<?xml version="1.0" encoding="utf-8" ?>'; ?><rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:spotify="http://www.spotify.com/ns/music/1" version="2.0">
    <channel>
        <title>
        ...
        <description>
            <![CDATA[Du lundi au vendredi à 13h15, Fabrice Grosfilley reçoit un.e invité.e issu.e du monde de la culture pour évoquer l’actualité du jour dans Toujours + d’actu, sur BX1+.]]>
        </description>
        <itunes:summary>
            Du lundi au vendredi à 13h15, Fabrice Grosfilley reçoit un.e invité.e issu.e du monde de la culture pour évoquer l’actualité du jour dans Toujours + d’actu, sur BX1+.
        </itunes:summary>
        <copyright>
        ...
        <image>
            <url>
                https://bx1plus.be/img/podcasts/logo_toujoursplusactu_grand.jpg
            </url>
            <title>
                Toujours + d'Actu
            </title>
        ...
        $loop = new WP_Query(array('post_type' => 'radio-chronique', 'meta_key' => '_yoast_wpseo_primary_radio-type_emissions', 'meta_value' => '13262', 'posts_per_page' => -1));
