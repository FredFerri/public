...
<channel>
   ...
   */
  do_action( 'rss2_head');
  $my_query = new WP_Query( array('post_type' => 'post', 'cat' => '2166', 'posts_per_page' => 6 ));
    ...
    <?php
      ...
      $article   .= "<td align=\"center\" valign=\"top\" class=\"templateColumnContainer\" style=\"padding-top:20px;\" width=\"300px\">
        <table border=\"0\" cellpadding=\"20\" cellspacing=\"0\" width=\"300px\">
          ...
          <tr>
            <td valign=\"top\">
              <font color=\"#fff\">" . $i . get_the_excerpt() . "</font><br/><br/>
              <table>
            	<tr>
            		<td>
              			<a href=\"" . get_the_permalink() . "\" class=\"readmorbutton\"><img src=\"http://bx1.be/img/readmore.png\" height=\"30px\" width=\"90px\" /></a>
              		</td>
              	</tr>
              </table>
            </td>
