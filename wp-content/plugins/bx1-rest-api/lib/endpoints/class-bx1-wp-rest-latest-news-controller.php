 ...
 */
class BX1_WP_REST_Latest_News_Controller extends WP_REST_Controller {

  public function __construct() {
    $this->version = '2';
    $this->namespace = 'wp/v' . $this->version;
    $this->rest_base = 'latest-news';
  }
  ...
  public function get_items($request) {
    ...
    // Lister en premier les "featured news" dans la liste
    $query_args['meta_query'] = array(
     'relation' => 'OR',
        array(
          'key'     => 'wpcf-featured-news',
          'compare' => 'NOT EXISTS',
        ),
        array(
          'key'     => 'wpcf-featured-news',
    ...
    $query_args['orderby'] = array(
      'wpcf-featured-news' => 'desc',
      'modified'           => 'desc',
      'date'               => 'desc',
    );
    // TODO remplacer "flash news" par "mettre en avant".
