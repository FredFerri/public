...
var iconPath = "http://" + window.location.hostname + "/wp-content/themes/bx1-advanced/img/weather_icons/";

$.getJSON( "http://api.openweathermap.org/data/2.5/find?q=Brussels,be&units=metric&lang=fr", function( data ) {
...
$.getJSON( "http://api.openweathermap.org/data/2.5/forecast/daily?q=Brussels,be&units=metric&cnt=4", function( data ) {
