...
<channel>
    ...
    <description>
        <![CDATA[Podcast +, présenté du lundi au vendredi de 16h à 17h par Jean-Jacques Deleeuw, met en lumière (et en son) les podcasts avec des extraits d’épisodes et des interviews des concepteurs et conceptrices.]]>
    </description>
    <itunes:summary>
        Podcast +, présenté du lundi au vendredi de 16h à 17h par Jean-Jacques Deleeuw, met en lumière (et en son) les podcasts avec des extraits d’épisodes et des interviews des concepteurs et conceptrices.
    </itunes:summary>
    <copyright>
        BX1 &#xA9; <?php echo date("Y");?>. Tous droits réservés.
    </copyright>
    <image>
      <url>https://bx1plus.be/img/podcasts/logo_podcastplus_grand.jpg</url>
      <title>Podcast +</title>
...
echo $dt->format('D, d M Y H:i:s O');
    ?></lastBuildDate> 
    <itunes:image href="https://bx1plus.be/img/podcasts/logo_podcastplus_grand.jpg" />
<?php 
//Let's use WP functions
require_once("../../../wp-load.php");
date_default_timezone_set('Europe/Brussels');
  $loop = new WP_Query( array('post_type' => 'radio-emission', 'meta_key' => '_yoast_wpseo_primary_radio-type_emissions','meta_value' => '13256','posts_per_page' => -1));
