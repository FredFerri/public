    ...
    <header class="siteHeader realHeader">
      <div class="inside">
        <div class="header-left">
          ...
          <?php if( $radio == true )
                {?>
                  <a href="<?php echo esc_url( home_url( '/radio/' ) ); ?>" title="Retour à l'accueil" rel="home" class="logo"><img style="margin-top:7px!important;" id="logoimg" src="https://bx1.be/wp-content/uploads/2025/04/Logo-BX1-2025_Baseline-NEW-min.png" alt="BX1 - Médias de Bruxelles" /></a>
                <?php }
                else {
                  ?>
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Retour à l'accueil" rel="home" class="logo"><img id="logoimg" src="https://bx1.be/wp-content/uploads/2025/04/Logo-BX1-2025_Baseline-NEW-min.png" alt="BX1 - Médias de Bruxelles" /></a>
        <?php } ?>
        ...
        <div class="header-center">
          <div class="header-btn-directtv">
            <a href="https://bx1.be/lives/direct-tv/?theme=classic"><img src="https://bx1.be/wp-content/uploads/2025/03/direct-tv.png"></a>
          </div>
          <div class="header-btn-directradio">
            <a href="https://player.bx1.be/player.php"><img src="https://bx1.be/wp-content/uploads/2025/03/direct-radio.png"></a>
          </div>          
        </div>
        <div class="header-right">
          <div class="header-btn-whatsapp">
            <a href="https://bx1.be/whatsapp/?theme=classic"><img src="https://bx1.be/wp-content/uploads/2025/03/whatsapp.png"></a>
          </div>
          <div class="header-btn-alert">
            <a href="https://bx1.be/alertez-nous?theme=classic"><img src="https://bx1.be/wp-content/uploads/2025/03/alertez-nous.png"></a>
          </div>
          <div class="header-btn-monbx1">
            <a href=""><img src="https://bx1.be/wp-content/uploads/2025/03/mon-bx1.png"></a>
          </div>          
