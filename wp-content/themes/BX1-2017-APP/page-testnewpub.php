...
get_header(); ?>
    <?php
            ...
            curl_error($getPub);
            curl_setopt($getPub, CURLOPT_POSTFIELDS,
	            'lat:50.846812,lng:4.352360,db:true,page:77,url:"https://www.bx1.be/",title:"Accueil",type:"News",image:"https://bx1.be/wp-content/uploads/2017/08/nophoto.png",uniqId:"' . $pubId . '",tags:""}');
