...
?>
         ...
         <footer id="colophon" class="site-footer footer-partners" >
            <?php
            ...
            if ( $queryPartenaires->have_posts() ) { ?>
              ...
              <div class="row" data-equalizer data-options="equalize_on_stack: true">
               ...
               <div class="partenaires text-center large-3 columns end" data-equalizer-watch>
                  <a class="partenaires__link" href="<?php echo types_render_field("partenaires-url"); ?>" target="_blank">
         ...
         <footer id="colophon-2" class="site-footer footer-top" >
            <div class="row">
         ...
         <footer id="colophon-3" class="site-footer footer-bottom" >
            <div class="row">
