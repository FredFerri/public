...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd"
    ...
    <channel>
        ...
        <description>
            <![CDATA[Le Micro ouvert, c’est un espace d’expression ouvert aux Bruxellois : un poème, un slam, une chanson… C’est à découvrir dans Toujours + d’actu, sur BX1+.]]>
        </description>
        <itunes:summary>
            Le Micro ouvert, c’est un espace d’expression ouvert aux Bruxellois : un poème, un slam, une chanson… C’est à découvrir dans Toujours + d’actu, sur BX1+.
        </itunes:summary>
        <copyright>
        ...
        $loop = new WP_Query(array('post_type' => 'radio-chronique', 'meta_key' => '_yoast_wpseo_primary_radio-type_emissions', 'meta_value' => '13261', 'posts_per_page' => -1));
