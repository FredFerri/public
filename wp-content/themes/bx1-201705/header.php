  ...
  <div class="off-canvas-wrap" data-offcanvas>
    <div class="inner-wrap">
      ...
      <div id="page" class="hfeed site">
                      ...
                      jwplayer("featured-video").setup({
                        playlist: [{
                          "sources": [{
                            ...
                            "file": "http://149.202.81.107:1935/vod/mp4:" + "<?php echo do_shortcode('[types field="exclu-web-id" output="raw"][/types]') ?>" + ".mp4" + "/playlist.m3u8"
                          }]
                        }],
                        primary: 'html5',
                  ...
                  jwplayer("featured-video").setup({
                    playlist: [{
                      ...
                      "sources": [{
                        ...
                        "file": "http://149.202.81.107:1935/vod/mp4:" + "<?php echo $featuredNewsVideoName; ?>" + ".mp4" + "/playlist.m3u8"
                      }]
                    }],
                    primary: 'html5',
                    flashplayer: '<?php echo get_template_directory_uri();?>/js/jwplayer/jwplayer.flash.swf',
                    ...
                    jwplayer("featured-video").setup({
                      playlist: [{
                        "sources": [{
                          ...
                          "file": "http://149.202.81.107:1935/vod/mp4:" + "<?php echo do_shortcode('[types field="nom-du-fichier-video" output="raw"][/types]') ?>" + ".mp4" + "/playlist.m3u8"
                        }]
                      }],
                      primary: 'html5',
                      flashplayer: '<?php echo get_template_directory_uri();?>/js/jwplayer/jwplayer.flash.swf',
        ...
        <div>
          <a id='blogmobiliteheader' href="/mobilite/"><img src="<?php echo get_template_directory_uri();?>/img/mobilitebanner.jpg"></a>
        </div>
