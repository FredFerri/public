...
function slug_register_post_video() {
  register_rest_field('post','wpcf-video-name-news',
    array(
...
function slug_register_post_featured() {
  register_rest_field('post','wpcf-featured-news',
    array(
      'get_callback' => 'slug_get_field',
      'update_callback' => null,
      'schema' => null,
...
function slug_register_post_flash() {
  register_rest_field('post','wpcf-flash-news',
    array(
      'get_callback' => 'slug_get_field',
      'update_callback' => null,
      'schema' => null,
...
function shortcode_video_insert($args) {
    ...
    if ( !empty($video_title) ) { ?>
       <div onmouseover="if(typeof alreadyHover === 'undefined'){jwplayer().setVolume(100);alreadyHover=1;}"><div id="video"></div></div>    
      <?php
      ob_start();
      ?>
