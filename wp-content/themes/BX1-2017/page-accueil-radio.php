    ...
    wp_reset_postdata();
      ...
      wp_reset_postdata();
        ...
        while ($loop->have_posts()) : ?>
          <div class="mireRadio">
            <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
            <span class="mireradiotitre">13h00 | <a href="https://bx1.be/radio-type_emissions/la-voix-est-libre/?theme=<?= isset($_GET['theme']) ? esc_attr($_GET['theme']) : 'classic' ?>">La voix est libre</a></span><span class="mireradiosstitre">
              <?php
              $loop->the_post();
              $do_not_duplicate[] = $post->ID;
              echo types_render_field('nom-animation'); ?>
