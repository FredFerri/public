...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
   ...
   <div class="entry-content">
      <?php
         $videoName = types_render_field('video-concours', array('raw'=>'true'));
         if ( !empty($videoName) ) { ?>
         <div id="video"></div>
         <script>
            jwplayer("video").setup({
              ...
              sources: [{
                  file: "rtmp://149.202.81.107:1935/vod/mp4:" + "<?php echo types_render_field('video-concours'); ?>" + ".mp4"},{
                  file: "http://149.202.81.107:1935/vod/mp4:" + "<?php echo types_render_field('video-concours'); ?>" + ".mp4" + "/playlist.m3u8"
              }],
              primary: "html5",
              width: "100%",
              aspectratio: "16:9",
