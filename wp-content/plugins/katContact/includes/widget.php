...
class ContactData extends WP_Widget {
  ...
  function widget($args, $instance) {
   ...
   if ($title) {
    ...
    echo $this->zipTown  . '<br />';

    $contactlink = get_permalink(icl_object_id(109,'page'));

    echo '<a href="'.$contactlink.'">'.__('View on the map', 'plugin').'</a></p>'; 
    echo '<p>' .'Email: ' . hide_email($this->email) . '<br />';
    echo __('Phone', 'plugin') . ': ' . $this->phone . '<br />'; 
...
class FacebookLike extends WP_Widget {
  ...
  function widget($args, $instance) {
   ...
   //    echo $before_title, $instance['title'], $after_title;
   //  }
   echo '<div class="widget-link social-like uk-clearfix">';

   echo '<h3 class="section-title--footer">'.__('Join us on Facebook', 'plugin').':</h3>';
   ...
   echo '<div class="widget-link social-like uk-clearfix">';
   echo '<h3 class="section-title--footer">'.__('Join us on Twitter', 'plugin').':</h3>';

   echo '<div class="ftwitter-follow-button"><a href="'. $this->twitterUrl .'" class="twitter-follow-button" data-show-count="true" data-show-screen-name="false">Follow @woluweparents</a></div>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\'://platform.twitter.com/widgets.js\';fjs.parentNode.insertBefore(js,fjs);}}(document, "script", "twitter-wjs");</script>';
  echo '</div>';
   echo '<div class="credits">';
   echo '© <a href="' . site_url() . '">' . $this->company . '</a> 2015 &ndash; ' . __('All rights reserved', 'plugin') . ' - Made by <a href="http://www.spade.be" target="_blank">Spade</a>';
  echo '</div>';
