...
$category = isset($data["categories"]["main"]["id"]) ? $data["categories"]["main"]["id"] : "";
...
<div class="agenda-detail">
	<div class="title category<?= $category ?>">
		<h1><?= isset($data["translations"]["fr"]["name"]) ? $data["translations"]["fr"]["name"] : "" ?></h1>
	</div>


	<div class="categories category<?= check_if_value($data["categories"]["main"]["id"]); ?>"><?php echo  "<H1><span class=\"square\"></span>" . check_if_value($data["categories"]["main"]["translations"]["fr"]) . " | " . check_if_value($data["categories"]["others"]["translations"]["fr"][0]) . "</H1>"; ?></div>
	<div class="row">
		...
		<div class="informations">
			<span class="category<?= check_if_value($data["categories"]["main"]["id"]); ?>">Informations</span>
			...
			<div class="infocontent" style="padding-left: 16px;"><?php
																					...
																					//echo date("d m Y",$data["date_start"]);
																					?> &mdash; <?php echo utf8_encode(strftime("%d %h %Y", strtotime($data["date_end"]))); ?></div>
