         ...
         <script>
            jwplayer("video").setup({
              ...
              sources: [{
                  ...
                  file: "http://149.202.81.107:1935/vod/mp4:" + "<?php echo types_render_field('video-name-news'); ?>" + ".mp4" + "/playlist.m3u8",type: "mp4"},{
                  file: "rtsp://149.202.81.107:1935/vod/" + "<?php echo types_render_field('video-name-news'); ?>" + ".mp4"}
              ],
              primary: "html5",
              width: "100%",
              aspectratio: "16:9",
