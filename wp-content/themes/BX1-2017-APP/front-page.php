...
<div class="articles">
  ...
  ?>
      ...
      <article class="news__article <?php if ($videoFileName != '') {
                                      echo 'news__article--video ';
                                    }
                                    echo $even_odd_class; ?>">
        <a href="<?php the_permalink(); ?>">
          <figure>
            <?php if (isset($flash) && $flash == '1'): ?><span class="flash">Flash info</span><?php endif; ?>
            ...
            <?php if (isset($exclusif) && $exclusif == '1'): ?><span class="flash exclusif">Info BX1</span><?php endif; ?>
