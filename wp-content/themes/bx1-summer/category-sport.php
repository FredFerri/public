...
get_header(); ?>
   ...
   <section id="primary" class="content-area large-8 columns">
      <main id="main" class="site-main archives-sport" role="main">

      <?php if ( have_posts() ) : ?>

         <header class="page-header">
            <h1 class="page-title section-title section-title--sport">Sport</h1>
         </header><!-- .page-header -->
         ...
         <?php $videoFileName = get_post_meta($post->ID, 'wpcf-video-name-news', true); ?>
            ...
            <div class="news news--sport medium-6 columns end">
               ...
               <div class="">
                 <div class="large-2 medium-2 left news__entry-date-wrap">
