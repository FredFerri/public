...
<?php
    ...
    <div class="mireRadio">
     ...
     while ( $loop->have_posts() ) : ?>
             <div class="mireRadio">
                  <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                     <span class="mireradiotitre">13h25 | <a href="https://bx1.be/radio-type_emissions/en-stoemelings/?theme=classic">En Stoemelings</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
     ...
     <?php
            $loop = new WP_Query( array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique','meta_value' => 'bruxelles-vit'));
                while ( $loop->have_posts() ) : ?>
                  <div class="mireRadio">
                 <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                  <span class="mireradiotitre">14h30 | <a href="https://bx1.be/radio-type_emissions/bruxelles-vit/?theme=classic">Bruxelles vit !</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
            ...
            $loop = new WP_Query( array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique','meta_value' => 'podcast-jour'));
                while ( $loop->have_posts() ) : ?>
                  <div class="mireRadio">
                  <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                  <span class="mireradiotitre">16h30 | <a href="https://bx1.be/radio-type_emissions/plus-de-podcast/?theme=classic">Podcast +</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
 ...
 <?php
        ...
        <span class="mireradiotitre">18h15 | <a href="https://bx1.be/radio-type_emissions/octave-plus/?theme=classic">Octave</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
...
<?php
            $loop = new WP_Query( array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique','meta_value' => 'le-grand-journal-du-rien'));
                while ( $loop->have_posts() ) : ?>
                  <div class="mireRadio">
                    <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
        <span class="mireradiotitre">19h00 | <a href="https://bx1.be/radio-type_emissions/le-grand-journal-du-rien/?theme=classic">Le Grand Journal du Rien</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
        ...
        ?>
            ...
            $loop = new WP_Query( array('post_type' => 'mire-radio', 'posts_per_page' => 1, 'meta_key' => 'wpcf-nom-emission-chronique','meta_value' => 'ta-bruxelles'));
                while ( $loop->have_posts() ) : ?>
                  <div class="mireRadio">
                  <h6 style="border-bottom : 1px solid grey; text-align:center; margin-top: 5px; margin-bottom: 15px">&nbsp;</h6>
                  <span class="mireradiotitre">20h00 | <a href="https://bx1.be/radio-type_emissions/t-a-bruxelles/?theme=classic">T A Bruxelles ?</a></span><span class="mireradiosstitre">
                  <?php
                  $loop->the_post();
                  $do_not_duplicate[] = $post->ID;
                  echo types_render_field('nom-animation'); ?>
